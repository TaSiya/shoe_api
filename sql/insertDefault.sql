insert INTO brands (name) values ('vovo');
insert INTO brands (name) values ('amateki');
insert INTO brands (name) values ('china teki');
insert INTO brands (name) values ('hoki');
insert INTO brands (name) values ('spharana');
insert INTO brands (name) values ('codered');

insert INTO colours (colourTag) values ('white');
